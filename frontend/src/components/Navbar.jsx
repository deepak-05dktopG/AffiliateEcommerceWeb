  ...
  return (
    <nav className="navbar  shadow-sm navbar-expand-lg navbar-custom sticky-top">
      <div className="container ">
        ...
        <div class="offcanvas offcanvas-end w-50 d-lg-none" style={{backgroundColor:"blue"}} data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
          <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasWithBothOptionsLabel">QualityPickss</h5>
